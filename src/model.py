...
from torch_geometric.nn import GCNConv, SAGEConv, GINConv, GIN, GATConv
from torch_geometric.nn import DenseGINConv, DenseSAGEConv, DenseGraphConv, DenseGCNConv, DenseGATConv
...
class Dense_GAT(torch.nn.Module):
    def __init__(self, in_channels, hidden_channels, num_conv_layers,
                 dropout, num_heads=8, num_classes=2):
...
class Dense_mask_training_GAT(Dense_GAT):
    ...
    def __init__(self, in_channels, hidden_channels, num_conv_layers, dropout, 
    device, args, previous_metamask_dir, num_heads=8, num_classes=2, prune_training_mask=0.05):
        super().__init__(in_channels, hidden_channels, num_conv_layers, dropout, num_heads, num_classes)
